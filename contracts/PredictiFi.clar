;; Title: PredictiFi Protocol
;; Summary: Decentralized Bitcoin Price Prediction Markets with Automated Rewards
;; Description: PredictiFi revolutionizes crypto forecasting by creating liquid
;;              prediction markets where traders stake STX tokens on Bitcoin's
;;              future price movements. Our protocol leverages Stacks' security
;;              model while providing instant settlements, dynamic liquidity pools,
;;              and algorithmic reward distribution. Perfect for DeFi enthusiasts
;;              seeking to monetize their market insights through transparent,
;;              oracle-driven price discovery mechanisms.

;; PROTOCOL CONSTANTS & ERROR MANAGEMENT
